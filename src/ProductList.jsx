...
function ProductList() {
  ...
  // const [addedToCart, setAddedToCart] = useState({}); // We don't need it anymore since we're using the selector now
  ...
  const handleAddToCart = (plant) => {
    ...
    // Left here for the assignment. However we don't need this call anymore since using the selector now.
    // setAddedToCart(prevAddedToCart => (
    //   {...prevAddedToCart, [plant.name]: true}
    // ));
  }
            ...
            <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
              <h1 className='cart'>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" id="IconChangeColor" height="68" width="68">
                  ...
                  <text x="100" y="150" fill="white">{addedToCart.reduce((acc, item) => (acc + item.quantity), 0)}</text>
